...
// function rollDice() {
    ...
    //! 2st Methode
    // var diceValue = Math.floor(Math.random() * 6) + 1;
    // document.write("diceResult" + diceValue);
...
// function generateRandomNumber() {
    ...
    //! 2st Methode
    // var user = +prompt("write Generate")
...
// var match = regex.exec(userInput);
// if (match) {
...
//     <p><strong>Charges per Unit:</strong> Rs.${chargesPerUnit.toFixed(2)}</p>
//     <p><strong>Net Amount Payable (within Due Date):</strong> Rs.${netAmountPayable}</p>
//     <p><strong>Late Payment Surcharge:</strong> Rs.${latePaymentSurcharge}</p>
//     <p><strong>Gross Amount Payable (after Due Date):</strong> Rs.${grossAmountPayable}</p>
// `;
